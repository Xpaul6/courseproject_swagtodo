...
function Parent_task() {
  ...
  return (
    <div className="flex justify-around items-center my-2 relative">
      ...
      <button
        className={`absolute right-3 p-2 cursor-pointer ${isOpen ? "rotate-180" : ""} transition-all duration-200`}
      ...
      <div
        className={`absolute right-7 bg-white top-8 flex flex-col justify-center shadow-md rounded-md
          overflow-hidden transition-all duration-200 ease-in-out ${isOpen ? "max-h-48 z-10" : "max-h-0 z-10"}`}
      >
